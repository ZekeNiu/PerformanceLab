        ...
        {!uploadState.includes('upload') && (
          <button
            onClick={(e) => {
              ...
              const sample1 = ['ATH-2024-001', '张伟', '2024夏训期初测', '2024-06-15', '爆发力', 'CMJ', 'CMJ 跳跃高度', 'cm', '42.3', '43.1', '41.8', '', '', '']
              const sample2 = ['ATH-2024-002', '李娜', '2024夏训期初测', '2024-06-15', '爆发力', 'CMJ', 'CMJ 峰值力', 'N', '2200', '2250', '2180', '', '', '']
