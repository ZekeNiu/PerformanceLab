  ...
  return (
    <div className="flex flex-1 items-center justify-center" style={{ color: 'var(--text-muted)' }}>
      <div className="text-center">
        ...
        <h2 className="text-h2" style={{ color: 'var(--text-secondary)' }}>Admin</h2>
        <p className="mt-2 text-body">Definition Library, Athlete Profiles, and Test Sessions coming soon.</p>
      </div>
    </div>
  )
}
